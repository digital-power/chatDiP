                ...
                self.responses.append(
                    {
                        ...
                        "choices": [
                            {
                                "delta": {"role": "assistant", "content": parts[1]},
                                "index": 0,
                                "finish_reason": None,
                            }
                        ],
...
def mock_confidential_client_success(monkeypatch):
    def mock_acquire_token_on_behalf_of(self, *args, **kwargs):
        ...
        return {
            ...
            "id_token_claims": {"oid": "OID_X", "groups": ["GROUP_Y", "GROUP_Z"]},
        }

    monkeypatch.setattr(
        msal.ConfidentialClientApplication,
        "acquire_token_on_behalf_of",
        mock_acquire_token_on_behalf_of,
    )
...
def mock_data_lake_service_client(monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        mock_get_file_system_client,
    )

    monkeypatch.setattr(
        azure.storage.filedatalake.aio.DataLakeServiceClient,
        "__init__",
    ...
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.DataLakeServiceClient,
        "get_file_system_client",
        mock_get_file_system_client_aio,
    )
    ...
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.FileSystemClient,
        "create_file_system",
        mock_create_filesystem_aio,
    )
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.FileSystemClient,
        "create_directory",
        mock_create_directory_aio,
    )
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.FileSystemClient,
    ...
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.DataLakeDirectoryClient,
        "get_file_client",
        mock_directory_get_file_client,
    )
    monkeypatch.setattr(
        azure.storage.filedatalake.aio.DataLakeDirectoryClient,
